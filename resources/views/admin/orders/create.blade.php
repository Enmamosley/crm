...
<form action="{{ route('admin.orders.store') }}" method="POST" class="max-w-2xl mx-auto space-y-6"
      x-data="invoiceForm">
    @csrf
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('admin.orders.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300">Cancelar</a>
    </div>
</form>
@endsection
