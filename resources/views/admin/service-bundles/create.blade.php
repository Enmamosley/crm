...
@section('header', 'Nuevo Paquete de Servicios')

@section('content')
<form action="{{ route('admin.service-bundles.store') }}" method="POST" id="bundleForm">
    @csrf
    <div class="max-w-2xl space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                       ...
                       placeholder="Ej. Startup Digital">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div id="services-container" class="space-y-3">
                {{-- Filas iniciales --}}
                <div class="service-row flex items-center gap-3" data-index="0">
                    <div class="flex-1">
                    ...
                    <div class="w-24">
                        <input type="number" name="services[0][quantity]" value="1" min="1" required
                ...
                <div class="service-row flex items-center gap-3" data-index="1">
                    <div class="flex-1">
                        <select name="services[1][service_id]" required
                                class="w-full border rounded-lg px-2 py-2 text-sm">
                            <option value="">Seleccionar servicio...</option>
                            @foreach($services as $service)
                            <option value="{{ $service->id }}">
                    ...
                    <div class="w-24">
                        <input type="number" name="services[1][quantity]" value="1" min="1" required
                               class="w-full border rounded-lg px-2 py-2 text-sm text-center" title="Cantidad">
                    </div>
                    <button type="button" onclick="removeServiceRow(this)" class="text-red-400 hover:text-red-600 p-1">
                        <i class="fas fa-times"></i>
